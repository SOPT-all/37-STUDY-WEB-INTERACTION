...
import { get$ } from "../public/js/utils.js";
...
class WeatherApp {
  ...
  bindEvents() {
    this.$elements.switchTemp.addEventListener(
      "click",
      this.eventHandler.toggleTemperature.bind(this.eventHandler)
    );
    this.$elements.searchInput.addEventListener(
      "input",
      this.eventHandler.handleSearchInput.bind(this.eventHandler)
    );
    this.$elements.searchInput.addEventListener(
      "focus",
      this.eventHandler.handleSearchInput.bind(this.eventHandler)
    ...
    document.addEventListener(
      "click",
      this.eventHandler.handleOutsideClick.bind(this.eventHandler)
    );
    this.$elements.searchInput.addEventListener(
      "keydown",
      this.eventHandler.handleKeyDown.bind(this.eventHandler)
    );
    this.$elements.cityList.addEventListener(
      "click",
      this.eventHandler.handleCitySelect.bind(this.eventHandler)
    );
    this.$elements.searchForm.addEventListener(
      "submit",
      this.eventHandler.handleSearch.bind(this.eventHandler)
    );
  }
